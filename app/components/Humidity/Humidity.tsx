...
const Humidity = () => {
    ...
    const getHumidityText = (humidity: number) => {
        if (humidity < 30) return "Dry: May sking cause irritation";
    ...
    return (
        <div className='py-6 px-4 h-[12rem] border rounded-lg flex flex-col gap-8 dark:bg-dark-gray shadow-sm dark:shadow-none'>
            <div className='top'>
